...
interface ModalAgregarCancionesProps {
...
export const ModalAgregarCanciones = ({
  tituloPlaylist,
  consulta,
  resultados,
  buscando,
      ...
      <div className="bg-neutral-900 rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto border border-white/10">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-white">
            Agregar canciones a "{tituloPlaylist}"
          </h3>
          <button
            onClick={onCerrar}
        ...
        {resultados.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-neutral-400">
              No se encontraron canciones con "{consulta}"
            </p>
