...
export default function CreateAlbum() {
  ...
  // Para agregar canciones al álbum
    ...
    try {
      ...
      if (portadaFile) {
        ...
        console.log("Uploading image:", {
          name: portadaFile.name,
          type: portadaFile.type,
          size: portadaFile.size,
        });
      ...
      // 2. Crear álbum con la URL de la portada
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-neutral-900 to-black p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-8">Crear Álbum</h1>
